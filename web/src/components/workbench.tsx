...
import { FileSearch, GitBranch, KeyRound, LayoutDashboard, Moon, Network, Server, Sun, Upload } from 'lucide-react'
import type { Analysis } from '../types/api'

export type View = 'overview' | 'endpoints' | 'sessions' | 'dependencies' | 'workflow'
